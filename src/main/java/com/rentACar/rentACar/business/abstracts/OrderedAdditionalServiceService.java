...
public interface OrderedAdditionalServiceService {
	...
	Result add(CreateOrderedAdditionalServiceRequest orderedAdditionalServiceRequest) throws OrderedAdditionalServiceAlreadyExistsException, AdditionalServiceNotFoundException, RentedCarNotFoundException;

	Result update(UpdateOrderedAdditionalServiceRequest updateOrderedAdditionalServiceRequest) throws OrderedAdditionalServiceNotFoundException, OrderedAdditionalServiceAlreadyExistsException;

	Result delete(int orderedAdditionalServiceId) throws OrderedAdditionalServiceNotFoundException;

	DataResult<List<OrderedAdditionalServiceListDto>> getByRentedCarId(int rentedCarId) throws RentedCarNotFoundException;
